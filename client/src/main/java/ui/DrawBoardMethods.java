...
public class DrawBoardMethods {
    public static String draw(ChessBoard board, boolean whitePerspective) {
        ...
        int rowStart, rowEnd, rowDirection;
        int colStart, colEnd, colDirection;

        if (whitePerspective) {
            rowStart = 8; rowEnd = 0; rowDirection = -1;
            colStart = 1; colEnd = 9; colDirection = 1;
        } else {
            rowStart = 1; rowEnd = 9; rowDirection = 1;
            colStart = 8; colEnd = 0; colDirection = -1;
        }
